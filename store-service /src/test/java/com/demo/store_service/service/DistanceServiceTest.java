...
import com.demo.store_service.config.DistanceConfig;
import com.demo.store_service.strategy.HaversineStrategy;
import com.demo.store_service.strategy.ManhattanStrategy;
...
class DistanceServiceTest {
    ...
    void calculateMeters_HaversineConfig_ShouldUseHaversineStrategy() {
        ...
        assertEquals(haversineStrategy.calculate(
                new com.demo.store_service.model.Location(40.9923307, 29.1244229),
                new com.demo.store_service.model.Location(40.986106, 29.1161293)),
                distance,
                0.001);
    }
